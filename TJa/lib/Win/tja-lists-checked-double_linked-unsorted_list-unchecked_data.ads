...
--| Description:                                                            |--
--|                                                                         |--
--|   This package includes type and methods for a unsorted double linked   |--
...
package TJa.Lists.Checked.Double_Linked.Unsorted_List.Unchecked_Data is
  ...
  -----------------------------------------------------------------------------
  --| "Member_Sorted" does the same as "Member" but for a sorted list.
  -----------------------------------------------------------------------------
...
end TJa.Lists.Checked.Double_Linked.Unsorted_List.Unchecked_Data;
