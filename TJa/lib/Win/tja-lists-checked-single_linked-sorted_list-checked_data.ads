...
--| Description:                                                            |--
--|                                                                         |--
--|   This package includes type and methods for a sorted single linked     |--
--|   list where the data inserted is the original data (if it's a pointer  |--
--|   the calling program must handle (de)allocation of data pointed to).   |--
--|   The data pointed to can be changed from calling program.              |--
--|                                                                         |--
-------------------------------------------------------------------------------
...
package TJa.Lists.Checked.Single_Linked.Sorted_List.Checked_Data is
