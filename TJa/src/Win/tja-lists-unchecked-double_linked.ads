...
--| Description:                                                            |--
--|                                                                         |--
--|   This package is the top level for unchecked double linked list data   |--
--|   structures in the TJa-library.                                        |--
--|                                                                         |--
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
package TJa.Lists.Unchecked.Double_Linked is

end TJa.Lists.Unchecked.Double_Linked;
